...
def f_13_meteo_nabel():
    ...
    file_info = {
        ...
        # TODO 'DIR_OUT_ICOS': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/13_meteo_nabel'),
        'DIR_OUT_LOGFILE': Path('logs'),
...
def f_17_meteo_profile():
    ...
    file_info = {
        ...
        'DATA_TIMESTAMP_KEEP_NON_ICOS': True,
        'DIR_OUT_ICOS': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/17_meteo_profile'),  # NEW Apr 2025
        'DIR_OUT_LOGFILE': Path('log'),
        'DIR_SOURCE_FILES': Path('//server/share/rawdata/FluxData/CH-DAV_Davos/17_meteo_profile'),  # NEW Apr 2025
