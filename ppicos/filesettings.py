...
def f_11_meteo_hut_prec():
    ...
    file_info = {
        ...
        'FILENAME_LENGTH': 42,
        'FILENAME_POSITION_DAY': [31, 33],
        'FILENAME_POSITION_HOUR': [34, 36],
        'FILENAME_POSITION_MINUTE': [36, 38],
        'FILENAME_POSITION_MONTH': [28, 30],
        'FILENAME_POSITION_YEAR': [23, 27],
        'OUTFILE_COMPRESSION': True,
        'OUTFILE_DELETE_UNCOMPRESSED': True,
        'OUTFILE_ICOS_FILENUMBER_FN': '03',
...
def f_13_meteo_meteoswiss():
    ...
    file_info = {
        ...
        'FILENAME_ID': 'VQAA77.*',
        'FILENAME_LENGTH': 19,
        'FILENAME_POSITION_DAY': [13, 15],
        'FILENAME_POSITION_HOUR': [15, 17],
        'FILENAME_POSITION_MINUTE': [17, 18],
        'FILENAME_POSITION_MONTH': [11, 13],
        'FILENAME_POSITION_YEAR': [7, 11],
        'OUTFILE_COMPRESSION': True,
        'OUTFILE_DELETE_UNCOMPRESSED': True,
        'OUTFILE_ICOS_FILENUMBER_FN': '02',
...
def f_13_meteo_nabel():
    ...
    file_info = {
        ...
        'FILENAME_LENGTH': 26,
        'FILENAME_POSITION_DAY': [20, 22],
        'FILENAME_POSITION_HOUR': [],
        'FILENAME_POSITION_MINUTE': [],
        'FILENAME_POSITION_MONTH': [18, 20],
        'FILENAME_POSITION_YEAR': [16, 18],
        'OUTFILE_COMPRESSION': True,
        'OUTFILE_DELETE_UNCOMPRESSED': True,
...
def f_15_meteo_snowheight():
    ...
    file_info = {
        ...
        'FILENAME_LENGTH': 30,
        'FILENAME_POSITION_DAY': [24, 26],
        'FILENAME_POSITION_HOUR': [],
        'FILENAME_POSITION_MINUTE': [],
        'FILENAME_POSITION_MONTH': [22, 24],
    ...
    # 'DATA_RENAME_COLUMNS': False,
    # 'DATA_SKIP_ROWS': [],
    # 'FILENAME_POSITION_YEAR': [10, 14],
    # 'FILENAME_POSITION_MONTH': [14, 16],
    # 'FILENAME_POSITION_DAY': [16, 18],
