...
def f_10_meteo():
    ...
    file_info = {
        ...
        'DIR_OUT_ICOS': Path('//nas12.ethz.ch/green_groups_gl_processing/CH-DAV_Davos/01_ICOS_TRANSFER/10_meteo'),
        'DIR_OUT_LOGFILE': Path('logs'),
        'DIR_SOURCE_FILES': Path('//nas12.ethz.ch/green_groups_gl_rawdata/FluxData/CH-DAV_Davos/10_meteo'),
...
def f_10_meteo_heatflag_sonic():
    ...
    file_info = {
        ...
        'DIR_OUT_ICOS': Path(
            '//nas12.ethz.ch/green_groups_gl_processing/CH-DAV_Davos/01_ICOS_TRANSFER/10_meteo_heatflag_sonic'),
...
def f_10_meteo_press():
    ...
    renaming_map = {
        'PA_H1_0_1_Avg': 'PA_1_1_1',
        'PA_T1_35_1_Avg': 'PA_1_2_1'
    }
    ...
    file_info = {
        ...
        'FILENAME_LENGTH': 28,
        'FILENAME_POSITION_DAY': [22, 24],
        'FILENAME_POSITION_HOUR': [],
        'FILENAME_POSITION_MINUTE': [],
        'FILENAME_POSITION_MONTH': [20, 22],
        'FILENAME_POSITION_YEAR': [16, 20],
        'OUTFILE_COMPRESSION': True,
        'OUTFILE_DELETE_UNCOMPRESSED': True,
...
def f_11_meteo_hut_prec():
    ...
    file_info = {
        ...
        'DATA_TIMESTAMP_FORMAT': '%Y-%m-%d %H:%M:%S',
        'DATA_TIMESTAMP_KEEP_NON_ICOS': True,
        'DIR_OUT_ICOS': Path('//nas12.ethz.ch/green_groups_gl_processing/CH-DAV_Davos/01_ICOS_TRANSFER/11_meteo_hut'),
        'DIR_OUT_LOGFILE': Path('log'),
        'DIR_SOURCE_FILES': Path('//nas12.ethz.ch/green_groups_gl_rawdata/FluxData/CH-DAV_Davos/11_meteo_hut'),
...
def f_12_meteo_forest_floor(forest_floor, table):
    ...
    file_info = {
        ...
        'DATA_TIMESTAMP_FORMAT': '%Y-%m-%d %H:%M:%S',
        'DATA_TIMESTAMP_KEEP_NON_ICOS': True,
        'DIR_OUT_ICOS': Path('//nas12.ethz.ch/green_groups_gl_processing/CH-DAV_Davos/01_ICOS_TRANSFER/12_meteo_forestfloor'),
        'DIR_OUT_LOGFILE': Path('log'),
        'DIR_SOURCE_FILES': Path('//nas12.ethz.ch/green_groups_gl_rawdata/FluxData/CH-DAV_Davos/12_meteo_forestfloor'),
        'FILENAME_FOR_ICOS': 'CH-Dav_BM_{year}{month:02d}{day:02d}_L{logger}_F{file}.csv',
        'FILENAME_LENGTH': 43,
        'FILENAME_POSITION_DAY': [32, 34],
        'FILENAME_POSITION_HOUR': [35, 37],
...
def f_17_meteo_profile():
    ...
    file_info = {
        ...
        'DATA_HEADER_REMOVE_SUFFIX_FROM_VARIABLE_NAMES': [],
        # 'DATA_HEADER_ROWS': [0],
        'DATA_HEADER_ROWS': [1],  # NEW Apr 2025
        'DATA_ICOS_TIMESTAMP_FORMAT': '%Y%m%d%H%M%S',
        # 'DATA_KEEP_ONLY_RENAMED_COLUMNS': False,
        'DATA_KEEP_ONLY_RENAMED_COLUMNS': True,  # NEW Apr 2025
        # 'DATA_RENAME_COLUMNS': False,
        'DATA_RENAME_COLUMNS': renaming_map,  # NEW Apr 2025
        'DATA_SEPARATOR': ',',
        # 'DATA_SKIP_ROWS': None,
        'DATA_SKIP_ROWS': [2, 3],  # NEW Apr 2025
        'DATA_TIMESTAMP_COL': 0,
        ...
        'FILENAME_ID': 'CH-DAV_meteo-profile_*.dat',  # NEW Apr 2025
        # CH-DAV_meteo-profile_20250401.dat
        # 'FILENAME_LENGTH': 30,
        'FILENAME_LENGTH': 33,  # NEW Apr 2025
        # 'FILENAME_POSITION_DAY': [16, 18],
        'FILENAME_POSITION_HOUR': [],
        'FILENAME_POSITION_MINUTE': [],
        # 'FILENAME_POSITION_MONTH': [14, 16],
        # 'FILENAME_POSITION_YEAR': [10, 14],
        'FILENAME_POSITION_DAY': [27, 29],  # NEW Apr 2025
        'FILENAME_POSITION_MONTH': [25, 27],  # NEW Apr 2025
        'FILENAME_POSITION_YEAR': [21, 25],  # NEW Apr 2025
        'OUTFILE_COMPRESSION': True,
        'OUTFILE_DELETE_UNCOMPRESSED': True,
        # 'OUTFILE_ICOS_FILENUMBER_FN': '02',
...
def f_30_profile_ghg():
    file_info = {
        ...
        'DATA_TIMESTAMP_FORMAT': '%Y%m%d%H%M%S',
        'DATA_TIMESTAMP_KEEP_NON_ICOS': True,
        'DIR_OUT_ICOS': Path('//nas12.ethz.ch/green_groups_gl_processing/CH-DAV_Davos/01_ICOS_TRANSFER/30_profile_ghg'),
        'DIR_OUT_LOGFILE': Path('logs'),
        'DIR_SOURCE_FILES': Path('//nas12.ethz.ch/green_groups_gl_rawdata/FluxData/CH-DAV_Davos/30_profile_ghg'),
