...
def f_10_meteo():
    ...
    file_info = {
        ...
        'f_LN': '02',
        'f_FN': '03',
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/10_meteo'),
        # 'f_source_dir': 'input',
        'f_log_subdir': Path('logs'),
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/10_meteo'),
...
def f_10_meteo_heatflag_sonic():
    ...
    file_info = {
        ...
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/10_meteo'),
        # 'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/10_meteo/2018/09'),
        'f_log_subdir': Path('log'),
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/10_meteo_heatflag_sonic'),
...
def f_12_meteo_forest_floor(forest_floor, table):
    ...
    file_info = {
        ...
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/12_meteo_forestfloor'),
        'f_log_subdir': Path('log'),
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/12_meteo_forestfloor'),
...
def f_13_meteo_meteoswiss():
    ...
    file_info = {
        ...
        'f_LN': '20',
        'f_FN': '02',
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/13_meteo_meteoswiss'),
        'f_log_subdir': Path('log'),
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/13_meteo_meteoswiss'),
...
def f_13_meteo_backup_eth():
    ...
    file_info = {
        ...
        'f_LN': '21',
        'f_FN': '04',
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/13_meteo_backup_eth'),
        # 'f_source_dir': Path('input'),
        'f_log_subdir': Path('logs'),
        # 'f_log_subdir': 'logs',
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/13_meteo_backup_eth'),
...
def f_13_meteo_nabel():
    ...
    file_info = {
        ...
        'f_LN': '22',
        'f_FN': '03',
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/13_meteo_nabel'),
        # 'f_source_dir': Path('input'),
        'f_log_subdir': Path('logs'),
        # 'f_log_subdir': 'logs',
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/13_meteo_nabel'),
        # 'icos_file_outpath': Path('output/13_meteo_backup_eth'),
        'f_compression': True,
        'f_delete_uncompressed': True
    }
...
def f_15_meteo_snowheight():
    ...
    file_info = {
        ...
        'f_LN': '01',
        'f_FN': '07',  # 2022-01-05
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/15_meteo_snowheight'),
        'f_log_subdir': Path('logs'),
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/15_meteo_snowheight'),
        'f_compression': True,
        'f_delete_uncompressed': True
    }
...
def f_17_meteo_profile():
    ...
    file_info = {
        ...
        'f_LN': '01',
        'f_FN': '02',
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/17_meteo_profile'),
        'f_log_subdir': Path('log'),
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/17_meteo_profile'),
...
def f_30_profile_ghg():
    file_info = {
        ...
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/30_profile_ghg'),
        # 'f_source_dir': 'input',
        'f_log_subdir': Path('logs'),
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/30_profile_ghg'),
