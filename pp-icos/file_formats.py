...
def f_11_meteo_hut_prec():
    ...
    file_info = {
        ...
        'f_LN': '03',
        'f_FN': '03',
        'f_source_dir': Path('//server/share/archive/FluxData/CH-DAV_Davos/11_meteo_hut'),
        'f_log_subdir': Path('log'),
        'icos_file_outpath': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/11_meteo_hut'),
        'f_compression': True,
        'f_delete_uncompressed': True
    }
...
def f_12_meteo_forest_floor(forest_floor, table):
    ...
    file_info = {
        ...
        'f_log_subdir': Path('log'),
        'icos_file_outpath': Path(
            '//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/12_meteo_forestfloor'),
