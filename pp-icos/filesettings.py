...
def f_10_meteo():
    ...
    file_info = {
        ...
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/10_meteo'),
...
def f_10_meteo_heatflag_sonic():
    ...
    file_info = {
        ...
        'DIR_OUT_ICOS': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/10_meteo_heatflag_sonic'),
...
def f_11_meteo_hut_prec():
    ...
    file_info = {
        ...
        'DIR_OUT_LOGFILE': Path('log'),
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/11_meteo_hut'),
...
def f_12_meteo_forest_floor(forest_floor, table):
    ...
    file_info = {
        ...
        'DIR_OUT_LOGFILE': Path('log'),
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/12_meteo_forestfloor'),
        'FILENAME_DAY_POSITION': [32, 34],
        'FILENAME_FOR_ICOS': 'CH-Dav_BM_{year}{month:02d}{day:02d}_L{logger}_F{file}.csv',
        'FILENAME_HOUR_POSITION': [35, 37],
        'FILENAME_LENGTH': 43,
...
def f_13_meteo_meteoswiss():
    ...
    file_info = {
        ...
        'DATA_TIMESTAMP_KEEP_NON_ICOS': True,
        'DIR_OUT_ICOS': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/13_meteo_meteoswiss'),
        'DIR_OUT_LOGFILE': Path('log'),
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/13_meteo_meteoswiss'),
...
def f_13_meteo_backup_eth():
    ...
    file_info = {
        ...
        'DATA_TIMESTAMP_FORMAT': '%Y-%m-%d %H:%M:%S',
        'DATA_TIMESTAMP_KEEP_NON_ICOS': True,
        'DIR_OUT_ICOS': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/13_meteo_backup_eth'),
        'DIR_OUT_LOGFILE': Path('logs'),
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/13_meteo_backup_eth'),
...
def f_13_meteo_nabel():
    ...
    file_info = {
        ...
        'DIR_OUT_LOGFILE': Path('logs'),
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/13_meteo_nabel'),
...
def f_15_meteo_snowheight():
    ...
    file_info = {
        ...
        'DATA_TIMESTAMP_KEEP_NON_ICOS': True,
        'DIR_OUT_ICOS': Path('//server/share/processing/CH-DAV_Davos/01_ICOS_TRANSFER/15_meteo_snowheight'),
        'DIR_OUT_LOGFILE': Path('logs'),
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/15_meteo_snowheight'),
...
def f_17_meteo_profile():
    ...
    file_info = {
        ...
        'DIR_OUT_LOGFILE': Path('log'),
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/17_meteo_profile'),
...
def f_30_profile_ghg():
    file_info = {
        ...
        'DIR_OUT_LOGFILE': Path('logs'),
        'DIR_SOURCE_FILES': Path('//server/share/archive/FluxData/CH-DAV_Davos/30_profile_ghg'),
